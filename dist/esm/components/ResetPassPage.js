...
function ResetPassPage({ data }) {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, data.status ? /* @__PURE__ */ React.createElement(ResetPassComponent, { data }) : /* @__PURE__ */ React.createElement(InvalidLink, null), " ", /* @__PURE__ */ React.createElement(Toaster, { richColors: true, position: "bottom-right" }));
}
