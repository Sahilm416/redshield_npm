...
async function AuthPage() {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Tabs, { className: " w-[90vw] max-w-[400px]", defaultValue: "login" }, /* @__PURE__ */ React.createElement(TabsList, { className: "grid dark:bg-slate-900 w-full grid-cols-2 rounded-none" }, /* @__PURE__ */ React.createElement(TabsTrigger, { className: " rounded-none", value: "login" }, "Login"), /* @__PURE__ */ React.createElement(TabsTrigger, { className: " rounded-none", value: "register" }, "Register")), /* @__PURE__ */ React.createElement(TabsContent, { value: "login" }, /* @__PURE__ */ React.createElement(
    LoginCard,
    {
