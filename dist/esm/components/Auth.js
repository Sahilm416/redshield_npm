...
async function AuthPage() {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Tabs, { className: "redshield-w-[90vw] redshield-max-w-[400px]", defaultValue: "login" }, /* @__PURE__ */ React.createElement(TabsList, { className: "redshield-grid redshield-bg-slate-900 redshield-w-full redshield-grid-cols-2 redshield-rounded-md" }, /* @__PURE__ */ React.createElement(TabsTrigger, { className: "redshield-rounded-md", value: "login" }, "Login"), /* @__PURE__ */ React.createElement(TabsTrigger, { className: "redshield-rounded-md", value: "register" }, "Register")), /* @__PURE__ */ React.createElement(TabsContent, { value: "login" }, /* @__PURE__ */ React.createElement(
    LoginCard,
    {
