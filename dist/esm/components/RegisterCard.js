...
const Form2 = ({
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("form", { action: sendData }, /* @__PURE__ */ React.createElement(CardContent, { className: "redshield-flex redshield-flex-col redshield-gap-3" }, /* @__PURE__ */ React.createElement("p", { className: "redshield-text-sm redshield-text-slate-400" }, "enter the code sent to ", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("span", { className: "redshield-text-slate-700" }, email), " "), /* @__PURE__ */ React.createElement(
    Input,
    {
      className: "redshield-rounded-none",
      name: "code",
